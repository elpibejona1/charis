<header>
	...
	<div class="container">
		...
		<ul class="header__nav header__nav--english">
			...
			<li class="featured"><a href="<?php echo $directory ?>en/prayer/">Global <br>Prayer Wall</a></li>
		
			<div class="header__languages">
				<ul>
					<li><a class="header__languages__link header__languages__link--fr" href="">Français</a></li>
					<li><a class="header__languages__link header__languages__link--en active" href="">English</a></li>
