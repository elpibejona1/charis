...
<body>
	...
	<?php $globalFunction->includeContent(2,'spanishDocumentsSubNav'); ?>
	...
	<div class="container">
		<div class="row row--documents">
			...
			<div class="interior__description">
				...
				<div class="primary__downloadContainer">
					<ul>
						<li class="primary__download__button"><a target="_blank" href="../../documents/charter/Alianza_Charis_Estatutos_(v2015.0).pdf">Descargar</a></li>
					</ul>
				</div>
			</div>
		</div>
		<div class="row row--documents">
			...
			<div class="interior__description">
				...
				<div class="primary__downloadContainer">
					<ul>
						<li class="primary__download__button"><a target="_blank" href="../../documents/ccci/Nuestro_Compromiso_a_la_Identidad_Comun_2015_(ESP_v2015.0).pdf">Descargar</a></li>
						<li class="primary__download__button primary__download__button--twoLines"><a target="_blank" href="../../documents/ccci/Nuestro_Compromiso_a_la_Identidad_Comun_2015_(ESP_v2015.0)_con_versiculos.pdf">Descargar <br>(con&nbsp;versos)</a></li>
					</ul>
				</div>
			</div>
		</div>
		<div class="row row--documents">
			...
			<div class="interior__description">
				...
				<div class="primary__downloadContainer">
					<ul>
						<li class="primary__download__button"><a target="_blank" href="../../documents/cccm/CCCM_Espanol.pdf">Descargar</a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="interior__description">
				...
				<div class="primary__downloadContainer">
					<ul>
						...
						<li class="primary__download__button"><a target="_blank" href="../../documents/ccci/Nosso_Compromisso_para_uma_Identidade_Comum_2015_(POR_v2015_0)_com_versos.pdf">Portugués</a></li>
					</ul>
				</div>
				<div class="primary__downloadContainer">
					<ul>
