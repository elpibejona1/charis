<?php /* Prayer Engine - RSS Feed of Prayer Tweets Specifically for Twitter  */
	...
	$getapprovedprayers = "SELECT * FROM prayers WHERE post_this = 1 AND twitter_ok = 1 AND (share_option = 'Share Online' OR share_option = 'Share Online Anonymously') " . $enmpe_displaylimitsql . " ORDER BY date_received DESC";
