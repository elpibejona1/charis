				...
				<div class="row">
					...
					<div class="timeline__event">
						...
						<div class="timeline__event__photo">
							...
							<p class="caption">Missionaries Roger and Nancy Peugh began holding Bible studies and worship services in their home.</p>
						</div>
						<div class="timeline__event__photo">
							<img src="../../_images/about/history/germany-image2.jpg" alt="">
							<p class="caption">A Church was planted in the city of Stuttgart, and later another began in&nbsp;Leonberg.</p>
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<div class="timeline__event">
						...
						<div class="timeline__event__photo">
							...
							<p class="caption">Ministry in Japan began in Hoya City (Greater Tokyo).</p>
						</div>
						<div class="timeline__event__photo">
							<img src="../../_images/about/history/japan-image2.jpg" alt="">
							<p class="caption">NorthStar, a mountain lodge in the Japanese Alps, seeks to reach the Japanese through extreme sports and outdoor activities.</p>
						</div>
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<div class="timeline__event">
						...
						<div class="timeline__event__photo">
							...
							<p class="caption">Ministry in Cambodia began through a partnership between Vek Huong Taing and Grace Brethren Missions.</p>
						</div>
						<div class="timeline__event__photo">
							<img src="../../_images/about/history/cambodia-image1.jpg" alt="">
							<p class="caption">Outreach has extended from larger cities to the surrounding villages.</p>
						</div>
					</div>
				</div>
				<div class="row">
