			...
			if (isset($pe_connected_okay)) { // Check to make sure The Prayer Engine's files are in the right directory
				if (!isset($e)) { // Check to make sure the database is set up properly
					...
					if ($checkrow == NULL) { // Check to see if the database has been installed yet
						...
						$dbh->exec("INSERT INTO settings (id, prayersdisplayed, displaylimit, ministryname, twitter, nospam, spamtheme, twitter_title, twitter_description, rss_title, rss_description, email, robot_email, activation, notification, mobile_site, moderation, stylesheet, login_timeout) VALUES ('1','10','nolimit','Your Ministry Name Here','no','0','white','Our Church Twitter Feed','This feed delivers the latest prayer tweets as soon as they\'re received.','Our Church Prayer Chain','This feed delivers the latest prayer requests as soon as they\'re received.','name@youremailaddress.com','robot@youremailaddress.com','yes','yes','yes','1','pe_color_scheme.css','900')");
