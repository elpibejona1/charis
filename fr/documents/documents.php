...
<body>
	...
	<?php $globalFunction->includeContent(2,'frenchDocumentsSubNav'); ?>
<div class="interior__background fullContainer">
	<div class="container">
		...
		<div class="row row--documents">
			...
			<div class="interior__description">
				<p class="interior__description__title"><span>Autres langues :</span></p>
				<p class="interior__description__subTitle">Charte de l’Alliance Charis</p>
				<div class="primary__downloadContainer">
					<ul>
						<li class="primary__download__button"><a target="_blank" href="../../documents/charter/Charter_German_(A4).pdf">Allemand</a></li>
						<li class="primary__download__button"><a target="_blank" href="../../documents/charter/Charter_Portuguese_(A4).pdf">Portugais</a></li>
