...
<body>
	...
	<? $globalFunction->includeContent(2,'mediaSubNav'); ?>
				...
				<div class="row">
					<div class="galleryPrev">
						<a class="fancybox" href="#gallery1">
							<img src="../../_images/media/photos/cile-2015-1/img1.jpg" alt="">
					...
					<div class="galleryPrev">
						<a class="fancybox" href="#gallery2">
							<img src="../../_images/media/photos/cile-2015-2/img1.jpg" alt="">
				...
				<div class="row">
					<div class="galleryPrev">
						<a class="fancybox" href="#gallery4">
							<img src="../../_images/media/photos/cile-2015-4/img1.jpg" alt="">
					...
					<div class="galleryPrev">
						<a class="fancybox" href="#gallery5">
							<img src="../../_images/media/photos/cile-2015-5/img1.jpg" alt="">
