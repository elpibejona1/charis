		...
		<div class="row accordion__top">
			...
			<div class="accordion__content">
				...
				<div class="interior__description">
					...
					<p>Access the <a class="inline" href="../documents/documents.php">Charis Commitment to Common Identity</a></p>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="accordion__content">
				...
				<div class="interior__description">
					...
					<p>Access the <a class="inline" href="../documents/documents.php">Charis Commitment to Common Mission</a></p>
				</div>
			</div>
		</div>
		<div class="row accordion__bottom">
			...
			<div class="accordion__content">
				...
				<div class="interior__description">
					...
					<p>If you would like more information about <span class="about__highlight">The Charis Alliance</span>, including the process for becoming part of this global movement, please send your inquiries to <a class="inline" href="mailto:info@charisalliance.org">info@charisalliance.org</a></p>
				</div>
			</div>
		</div>
	</div>
