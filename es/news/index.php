...
<body>
	...
	<?php $globalFunction->includeContent(2,'spanishNewsSubNav'); ?>
<div class="news__background fullContainer">
	<div class="container">
		<div class="row row--documents">
			<div class="news__photo">
				<a href="../celebracion/" target="_blank">
					<img src="../../_images/news/thumbnail1.jpg" alt="">
				</a>
			</div>
			<div class="news__description">
				<h4>Miércoles 23 de agosto</h4>
				<h3><a href="../celebracion/" target="_blank">Un Domingo Para Celebrar la Alianza de Charis (2017)</a></h3>
