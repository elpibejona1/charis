...
<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
  <channel>
	...
	<item>
      <title><?php if (($prayer['share_option'] == "Share Online Anonymously") || (($prayer['share_option'] == "Share Online") && (strlen($prayer['name']) == 0))) { ?>Motoivo anónimo<?php } else { ?>Motivo enviado por <?php echo htmlspecialchars(stripslashes($prayer['name'])); ?> <?php }; ?></title>
